...
class SSP {
    ...
    static function simple2 ( $request, $sql_details, $table, $primaryKey, $columns, $joinQuery = NULL, $extraWhere = '', $groupBy = '', $having = '', $orderby = '')
    {
        ...
        else $order = SSP::order( $request, $columns, $joinQuery );
        $order = "";
